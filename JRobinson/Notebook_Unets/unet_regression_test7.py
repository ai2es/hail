...
print('Hello World')
infiles = '/ourdisk/hpc/ai2es/hail/images_for_learning/*'
checkpoint_path = 'unet_test_data/unet_regression_test19_output.csv'
...
checkpoint = tf.keras.callbacks.ModelCheckpoint('unet_test_data/regression_test_19',
...
plt.show()
plt.savefig('train_loss19.png',dpi=300)
...
plt.savefig('newML_output19.png',dpi=300)
#validation_freq=5,
