...
checkpoint_path = 'unet_test_data/updated_regression_test7'
...
checkpoint = tf.keras.callbacks.ModelCheckpoint('unet_test_data/updated_regression_test7',
...
plt.show()
plt.savefig('test_loss7.png',dpi=300)
...
plt.savefig('newML_output7.png',dpi=300)