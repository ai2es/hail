...
#
#################################################
/home/tgschmidt/tf_gpu_env/bin/tensorboard --logdir="/ourdisk/hpc/ai2es/severe_nowcasting/hail_nowcasting/3d_unets-1_hour-128_size-more_fields/saved_models/tensorboard_logdir" --port=6065 --bind_all
