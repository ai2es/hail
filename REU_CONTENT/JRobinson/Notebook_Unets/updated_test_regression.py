...
metadata_outfile_name = 'updated_regression_test_output2.csv'
...
checkpoint = tf.keras.callbacks.ModelCheckpoint('unet_test_data/updated_regression_test2',
...
plt.show()
plt.savefig('train_loss1.png',dpi=300)
...
plt.savefig('newML_output1.png',dpi=300)