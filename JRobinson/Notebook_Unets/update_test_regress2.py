...
metadata_outfile_name = 'updated_regression_test_output3.csv'
...
checkpoint = tf.keras.callbacks.ModelCheckpoint('unet_test_data/updated_regression_test3',
...
plt.show()
plt.savefig('train_loss3.png',dpi=300)
...
plt.savefig('newML_output3.png',dpi=300)