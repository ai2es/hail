...
metadata_outfile_name = 'updated_regression_test_output4.csv'
...
checkpoint = tf.keras.callbacks.ModelCheckpoint('unet_test_data/updated_regression_test4',
...
plt.show()
plt.savefig('train_loss6.png',dpi=300)
...
plt.savefig('newML_output6.png',dpi=300)